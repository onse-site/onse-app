...
export default function UserDropdown() {
  ...
  const [memebr, setMemebr] = useState<Memebr | null>(null);
    ...
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden  rounded-full h-11 w-11">
          <img src={memebr?.avatar} alt="User" />
        </span>
      ...
      >
        <div>
          ...
          <span
            className={`inline-flex mt-2 items-center rounded-md bg-green-50 text-green-500  px-8 py-1 text-xs font-medium ring-1 ring-gray-500/10 ring-inset`}
          >
            {memebr?.role}
          </span>
        </div>
